...
//        spinner.setAdapter(adapter);
        final String[] items = new String[] {"January", "February", "March", "April", "May", "June", "July", "August", "September", "Ocktober", "November", "December"};
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot.exists()){
                                ...
                                for(DataSnapshot data: dataSnapshot.getChildren()) {
                                    ...
                                    monthDurationArr[0] +=(history.getDuration1())/(3600*1000);
                                    monthDurationArr[1] +=(history.getDuration2())/(3600*1000);
                                    monthDurationArr[2] +=(history.getDuration3())/(3600*1000);
                                    monthDurationArr[3] +=(history.getDuration4())/(3600*1000);
                                }
    ...
    private void calculateTotalKWH(){
        ...
        for(int i=0;i<wattArr.length;i++){
            kwhArr[i]=monthDurationArr[i]*wattArr[i];
            totalKWH+=kwhArr[i];
        }

        TextView tvtotalKWH=findViewById(R.id.totalKWH);
        tvtotalKWH.setText(String.format("%.2f",totalKWH/1000));
    }
